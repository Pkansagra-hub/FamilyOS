...
memory_operation_var: ContextVar[Optional[str]] = ContextVar('memory_operation', default=None)
family_context_var: ContextVar[Optional[dict]] = ContextVar('family_context', default=None)
