...
def load_local_schema(schema_path: str, base_dir: Path) -> Dict[str, Any]:
...
def validate_basic(schema: Dict[str, Any], data: Dict[str, Any]) -> List[str]:
    ...
    try:
        ...
        for ex in example_paths:
            try:
                ...
                # Use only basic validation to avoid external reference issues
                error_messages = validate_basic(schema, data)
